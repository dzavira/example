...
public enum EncodeHintType {
	 ...
	 * {@link dev.mrzha.scan01.qrcode.decoder.ErrorCorrectionLevel
	 * ErrorCorrectionLevel}. For Aztec it is of type {@link Integer},
	 * representing the minimal percentage of error correction words. Note: an
	 * Aztec symbol should have a minimum of 25% EC words.
	 */
	ERROR_CORRECTION,
	 ...
	 * {@link dev.mrzha.scan01.datamatrix.encoder.SymbolShapeHint})
	 */
	DATA_MATRIX_SHAPE,
	 ...
	 * {@link dev.mrzha.scan01.pdf417.encoder.Compaction Compaction}).
	 */
	PDF417_COMPACTION,

	/**
	 * Specifies the minimum and maximum number of rows and columns for PDF417
	 * (type {@link dev.mrzha.scan01.pdf417.encoder.Dimensions Dimensions}).
	 */
	PDF417_DIMENSIONS,

	/**
	 * Specifies the required number of layers for an Aztec code: a negative
	 * number (-1, -2, -3, -4) specifies a compact Aztec code 0 indicates to use
	 * the minimum number of layers (the default) a positive number (1, 2, ..
	 * 32) specifies a normaol (non-compact) Aztec code
	 */
	AZTEC_LAYERS,
}
