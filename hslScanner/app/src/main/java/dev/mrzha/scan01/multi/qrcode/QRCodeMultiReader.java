...
package dev.mrzha.scan01.multi.qrcode;

import dev.mrzha.scan01.reader.BarcodeFormat;
import dev.mrzha.scan01.reader.BinaryBitmap;
import dev.mrzha.scan01.reader.DecodeHintType;
import dev.mrzha.scan01.reader.NotFoundException;
import dev.mrzha.scan01.reader.ReaderException;
import dev.mrzha.scan01.reader.Result;
import dev.mrzha.scan01.reader.ResultMetadataType;
import dev.mrzha.scan01.reader.ResultPoint;
import dev.mrzha.scan01.common.DecoderResult;
import dev.mrzha.scan01.common.DetectorResult;
import dev.mrzha.scan01.multi.MultipleBarcodeReader;
import dev.mrzha.scan01.multi.qrcode.detector.MultiDetector;
import dev.mrzha.scan01.qrcode.QRCodeReader;
import dev.mrzha.scan01.qrcode.decoder.QRCodeDecoderMetaData;
