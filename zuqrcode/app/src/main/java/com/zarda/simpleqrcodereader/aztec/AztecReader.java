...
package com.zarda.simpleqrcodereader.aztec;

import java.util.List;
import java.util.Map;

import com.zarda.simpleqrcodereader.aztec.decoder.Decoder;
import com.zarda.simpleqrcodereader.aztec.detector.Detector;
