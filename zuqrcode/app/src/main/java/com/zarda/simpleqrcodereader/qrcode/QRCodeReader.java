...
package com.zarda.simpleqrcodereader.qrcode;
...
import com.zarda.simpleqrcodereader.qrcode.decoder.Decoder;
import com.zarda.simpleqrcodereader.qrcode.decoder.QRCodeDecoderMetaData;
import com.zarda.simpleqrcodereader.qrcode.detector.Detector;
...
public class QRCodeReader implements Reader {
	...
	public final Result decode(BinaryBitmap image, Map<DecodeHintType, ?> hints)
		...
		Result result = new Result(Normalize(decoderResult.getText()),
	...
	private static BitMatrix extractPureBits(BitMatrix image)
		...
		Log.e("mod size ", String.valueOf(moduleSize));
