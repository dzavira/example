...
final class DecodedBitStreamParser {
	...
	private static final int GB0991_SUBBIT = 8;
					...
					if (mode == Mode.FNC1_FIRST_POSITION
						...
						if (mode == Mode.HANZI) {
							...
							int count = bits.readBits(mode
									.getCharacterCountBits(version)) + GB0991_SUBBIT;
							if (mode == Mode.NUMERIC) {
								...
								Log.e("panjang ini byte ", String.valueOf(result));
