...
(function (global, factory) {
  ...
  function decodeByte(stream, size, encoding) {
    ...
    console.log("size :"+size+" : "+characterCountSize);
    var length = stream.readBits(characterCountSize);
 ...
 //   console.log("bit nya :"+(byte << 1) +" " + bit);
    return (byte << 1) | bit; 
  }
  ...
  function readFormatInformation(matrix) {
    ...
    for (var x = 0; x <= 8; x++) {
      if (x !== 6) {
        ...
        console.log("top left "+ x+" : "+topLeftFormatInfoBits);
      }
    }
    for (var y = 7; y >= 0; y--) {
      if (y !== 6) {
  ...
  function decodeMatrix(matrix) {
    ...
    var resultBytes = new Uint8ClampedArray(totalBytes +8);
    var resultIndex = 0;
    for (var _i = 0, dataBlocks_3 = dataBlocks; _i < dataBlocks_3.length; _i++) {
      ...
      for (var i = 0; i < (dataBlock.numDataCodewords +0 ); i++) {
        var cek=resultIndex++;
        resultBytes[cek] = correctedBytes[i];
      }

    }
    resultBytes = correctedBytes;
    try {
  ...
  //var horizontalRegionCount = 60;
    console.log("horizontal :"+horizontalRegionCount +" "+width);
  ...
  //console.log("test matrix :"+JSON.stringify(matrix));
    ...
    console.log("lokasi :"+JSON.stringify(locations));
    if (!locations) {
      return null;
    }
    for (var _i = 0, locations_1 = locations; _i < locations_1.length; _i++) {
      var location_1 = locations_1[_i];
      console.log("lokasi :"+JSON.stringify(locations_1));
      var extracted = extract(matrix, location_1);
     // console.log("ekstrak :"+JSON.stringify(extracted));
      var decoded = decode(extracted.matrix);
     // console.log("deco :"+JSON.stringify(decoded));
      if (decoded) {
...
//console.log("data 1 :"+data); // image berupa data text
