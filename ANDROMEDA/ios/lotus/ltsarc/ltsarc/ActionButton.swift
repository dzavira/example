...
open class ActionButton: NSObject {
    ...
    open var backgroundColor: UIColor = UIColor(red: 120.0/255.0, green: 219.0/255.0, blue: 26.0/255.0, alpha:1.0) {
        willSet {
    ...
    open var backgroundColorSelected: UIColor = UIColor(red: 120.0/255.0, green: 219.0/255.0, blue: 26.0/255.0, alpha:1.0)
